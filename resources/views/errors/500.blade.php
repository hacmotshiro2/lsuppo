        ...
        <div class="bg-white py-6 sm:py-8 lg:py-12">
            <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-indigo-500 text-sm md:text-base font-semibold uppercase mb-4">500</p>
                    <h1 class="text-gray-800 text-2xl md:text-3xl font-bold text-center mb-2"> サポーターへお問い合わせ下さい</h1>
