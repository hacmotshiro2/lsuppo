    ...
    <div class="grid md:grid-cols-2 gap-8 mb-8">
      ...
      <div class="md:py-8">
        ...
        <div class="mb-2 md:mb-3">
          <span class="inline-block text-gray-500 mb-0.5">エルコイン残高</span>
        ...
        <div class="mt-10 md:mt-16 lg:mt-20">
          <span class="text-gray-800 text-lg font-semibold mb-3">コイン明細</span>
          <table class="table-fixed text-base">
            <tr>
                <th class="w-2/9 bg-gray-300 text-slate-200 px-2 py-2">発生日</th>
