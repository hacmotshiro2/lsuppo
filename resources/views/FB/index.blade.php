    ...
    @for($i=0;$i<count($items);$i++)
      ...
      <div class="py-8 flex flex-nowrap">
        ...
        <div class="ml-4 flex-grow">
          ...
          <div class="w-full"><span><a class="text-indigo-500 inline-flex items-center mt-4" href="\fb\detail\{{$items[$i]->FbNo}}">read More
        ...
        <div class="w-10 md:w-24 mx-2 md:mb-0 mb-0 flex-none">
          <div class="table w-full">
            <div class="table-row-group">
              <div class="table-row">
                <span class="mt-1 md:mt-4 w-full"><a class="text-indigo-500 items-center" href="\fb\edit\{{$items[$i]->FbNo}}">編集</a></span>
              </div>
              <div class="table-row">
                <span class="mt-1 md:mt-4  w-full"></span>
              </div>
              <div class="table-row">
                <span class="mt-1 md:mt-4  w-full"><a class="text-indigo-500 items-center" href="\fb\delete\{{$items[$i]->FbNo}}">削除</a></span>
              </div>
            </div>
          </div>
        </div>
