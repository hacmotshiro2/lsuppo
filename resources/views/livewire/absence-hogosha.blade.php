<div class="container">
    <div class="relative overflow-x-scroll my-6">
        ...
        <div class="w-full grid grid-cols-2 gap-1 md:gap-2 mb-4">
            ...
            @endif
                ...
                <label for="rd-mihurikae" class="py-4 ml-2 text-sm md:text-xl font-medium text-gray-900 dark:text-gray-300">未振替</label>
            ...
            @endif
                ...
                <label for="rd-hurizumi" class="py-4 ml-2 text-sm md:text-xl font-medium text-gray-900 dark:text-gray-300">振替済み</label>
            ...
            <table class="table w-full text-left min-w-full shadow-md"  >
                ...
                <tbody class="text-sm md:text-base lg:text-lg text-gray-700">
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="border border-slate-300 p-2">@if(!empty($item->LCMeisaiId))<a href="/lc/">エルコインを確認 </a>@endif</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    <div>
        <a href="/lc/"><span class="text-indigo-800 text-base sm:text-xl mb-2 md:mb-6">エルコインを確認 ></span></a>
    </div>
</div>