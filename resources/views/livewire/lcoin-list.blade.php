<div class="w-full mt-6 md:mt-8">
    ...
    <table class="table-fixed">
        <tr>
            ...
            <th class="sort bg-gray-300 text-slate-50 p-4" wire:click="sortOrder('id')">id {!! $sortLink !!}</th>
            <th class="bg-gray-300 text-slate-50 p-2">欠席情報id</th>
            <th class="bg-gray-300 text-slate-50 p-2">Action</th>
        </tr>
        @foreach($items as $item)
        <tr class="hover:bg-indigo-50 hover:font-bold border-b-2 border-gray-400">
